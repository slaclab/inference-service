...
INPUTS_CONFIG = {
    "QUAD:LI21:211:BCTRL": {
        "range": [3.0, 7.87894145479219],
        "default": 6.0478018
    },
    "QUAD:LI21:221:BCTRL": {
        "range": [-0.6148016000000001, 0.8130961532115308],
        "default": -0.0875696
    }
}
...
class InferenceStressTester:
    ...
    def run_once(self):
        ...
        if success:
            ...
            print(f"    Inputs:  QUAD:211={inputs['QUAD:LI21:211:BCTRL']:+.6f} | "
                  f"QUAD:221={inputs['QUAD:LI21:221:BCTRL']:+.6f}")
            print(f"    Outputs: pulse_intensity={outputs.get('hxr_pulse_intensity', 0):.2f}")
